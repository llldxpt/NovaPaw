# -*- coding: utf-8 -*-
"""
Skill security scanner for NovaPaw.
...
Quick start::
    ...
    from novapaw.security.skill_scanner import SkillScanner
...
def _get_scan_mode(cfg: Any = None) -> str:
    ...
    Priority: env ``NOVAPAW_SKILL_SCAN_MODE`` > config > default ``warn``.
    """
    env = EnvVarLoader.get_str("NOVAPAW_SKILL_SCAN_MODE") or None
    if env is not None:
        val = env.lower().strip()
...
_WORKING_DIR_CURRENT_NAME = ".novapaw"
_WORKING_DIR_LEGACY_NAME = ".novapaw"
