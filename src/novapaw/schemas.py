# -*- coding: utf-8 -*-
"""NovaPaw streaming envelope schema.
...
novapaw's own envelope protocol — independent of agentscope's internal
event types.
"""
...
# ---------------------------------------------------------------------------
# Message envelope.
# novapaw's runner constructs an empty ``Message`` then calls
...
# These are constructed by novapaw rather than parsed from external input
