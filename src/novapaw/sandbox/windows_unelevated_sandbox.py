...
def _sandbox_file_lock(sandbox_name: str):
    ...
    """
    lock_dir = _novapaw_state_dir / "unelevated_sandboxes"
...
def _unelevated_sandboxes_dir() -> Path:
    ...
    return _novapaw_state_dir / "unelevated_sandboxes"
...
class WindowsUnelevatedSandbox(WindowsSandboxBase):
    ...
    def _initialize_sync(self) -> None:
        ...
        sandbox_name = f"novapaw_u_{fingerprint[:12]}"
...
class DenyPathsProtection:
    ...
    def __init__(self) -> None:
        ...
        self._state_file = _novapaw_state_dir / "deny_paths_protection.json"
    ...
    def cleanup_orphaned(cls) -> None:
        ...
        """
        state_file = _novapaw_state_dir / "deny_paths_protection.json"
...
def _migrate_legacy_state_file() -> None:
    ...
    legacy_file = _novapaw_state_dir / "unelevated_sandbox_state.json"
...
def _move_to_failed_cleanup_unelevated(
    ...
    failed_dir = _novapaw_state_dir / "failed_cleanup"
