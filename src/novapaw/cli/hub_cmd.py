# -*- coding: utf-8 -*-
"""CLI entry point for NovaPaw Hub."""
...
def hub_cmd(
    ...
    """Run the multi-user NovaPaw Hub control plane."""
    ...
    try:
        ...
        if exc.name != "docker":
            raise
        raise click.ClickException(
            f"NovaPaw Hub dependency {exc.name!r} is not installed. "
            f"Install novapaw[hub] to provide {exc.name!r} and try again.",
        ) from exc
