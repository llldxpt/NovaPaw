...
TELEMETRY_INFO = """
Help improve NovaPaw by sharing anonymous usage data!

We collect only:
• NovaPaw version (e.g., 0.0.7)
...
This helps us understand NovaPaw's usage environment and prioritize improvements.
"""
...
def _echo_telemetry_info_box() -> None:
    ...
    console.print(
        Panel(
            ...
            title="[bold]📊 Help improve NovaPaw[/bold]",
            border_style="blue",
        ),
    )
