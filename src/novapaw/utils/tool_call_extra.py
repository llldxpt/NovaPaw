...
``NovaPawAgent._save_to_context`` moves it into the owning ``Msg.metadata``
...
TOOL_CALL_EXTRAS_METADATA_KEY = "_novapaw_tool_call_extras"
_TRANSIENT_TOOL_CALL_EXTRA_ATTR = "_novapaw_tool_call_extra"
