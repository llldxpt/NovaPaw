...
_LOG_BACKUP_COUNT = 3
_LOG_MAX_SIZE_ENV = "NOVAPAW_LOG_MAX_SIZE"
_LOG_BACKUP_COUNT_ENV = "NOVAPAW_LOG_MAX_BACKUPS"
...
def add_project_file_handler(log_path: Path) -> None:
    ...
    override these with NOVAPAW_LOG_MAX_SIZE and NOVAPAW_LOG_MAX_BACKUPS.
