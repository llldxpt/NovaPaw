...
MAX_IMAGE_PIXELS_ENV = "NOVAPAW_MAX_IMAGE_PIXELS"
...
def image_pixel_limit_hint(exc: Exception) -> str | None:
    ...
    if provider_limit is None:
        return (
            ...
            f"maximum pixel count and restart NovaPaw to enable "
