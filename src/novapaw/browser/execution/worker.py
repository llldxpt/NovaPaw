...
class _ReturnRewriter(ast.NodeTransformer):
    ...
    def visit_Return(self, node: ast.Return) -> ast.AST:
        call = ast.Call(
            func=ast.Name(id="__novapaw_block_return__", ctx=ast.Load()),
...
_IDENTITY_ANCHOR = (
    "This is NovaPaw's builtin Browser SDK, not Playwright. "
...
def _internal_error_result(
    ...
    return ExecResult(
        ...
        error={
            ...
            "reason": "NovaPaw Browser SDK internal failure",
            "detail": f"{type(exc).__name__}: {exc}",
            "teaching": (
                "NovaPaw Browser SDK internal failure - retrying the "
...
async def execute_request(
    ...
    try:
        with contextlib.redirect_stdout(stdout):
            reset_perception_count()
            namespace["__novapaw_block_return__"] = BlockReturn
        ...
        return ExecResult(
            ...
            error={
                ...
                "detail": str(exc),
                "teaching": (
                    "Do not import the NovaPaw Browser SDK — Browser is "
