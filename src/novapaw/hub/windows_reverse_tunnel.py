...
class WindowsReverseTunnelBroker:
    ...
    def start(self) -> None:
        ...
        self._start_thread(self._accept_public, "novapaw-tunnel-public")
        self._start_thread(self._accept_control, "novapaw-tunnel-control")
    ...
    def _handle_tunnel_connection(
        ...
        self._start_thread(
            ...
            f"novapaw-tunnel-{handshake[2][:8]}",
        )
