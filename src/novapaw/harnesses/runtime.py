...
class HarnessRuntime:
    """Own adapters for one workspace and expose NovaPaw envelopes."""
    ...
    async def stream(  # pylint: disable=too-many-branches,too-many-statements
        ...
        *,
        ...
        """Run a harness turn and emit the established NovaPaw protocol."""
    ...
    async def hydrate_session(
        ...
        *,
        ...
        """Recover an unmaterialized provider thread into NovaPaw."""
