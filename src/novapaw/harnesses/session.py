# -*- coding: utf-8 -*-
"""Persist provider-neutral third-party turns in NovaPaw sessions."""
...
class HarnessSessionBridge:
    ...
    async def has_history(
        ...
        *,
        ...
        """Return whether NovaPaw already has a materialized transcript."""
    ...
    async def hydrate(
        ...
        *,
        ...
        """Save recovered provider history when no NovaPaw context exists."""
