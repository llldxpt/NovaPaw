# -*- coding: utf-8 -*-
"""NovaPaw-native tool documentation compression.

NovaPaw's built-in tools are ordinary Python functions. AgentScope derives
...
def plan_novapaw_tool_documentation(
    tools: list[dict],
) -> tuple[list[dict], str]:
    ...
    if rendered:
        rendered = (
            "=== TOOL REFERENCE ===\n"
            "NovaPaw moved optional-parameter descriptions here to reduce "
...
__all__ = ["plan_novapaw_tool_documentation"]
