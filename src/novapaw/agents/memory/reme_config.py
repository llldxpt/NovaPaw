...
``reme/config/default.yaml``. NovaPaw embeds ReMe as an in-process application,
...
def _base_config() -> dict[str, Any]:
    ...
    return {
        ...
        "jobs": {
            ...
            # NovaPaw schedules Daily Paper through ServiceCronJob using the
            ...
            # Auto Fin is available for explicit execution, but NovaPaw must
