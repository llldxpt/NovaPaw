...
class BaseChannel(ABC):
    ...
    def _strip_event_headlines(
        ...
        """
        from novapaw.agents.context.scroll.serialize import (
            HeadlineDeltaState,
            strip_headline,
    ...
    def _model_fallback_events(event: Any) -> List[Dict[str, str]]:
        ...
        raw_events = event_source.get("novapaw_model_fallbacks")
    ...
    def _clear_session_turn_usage(session_id: str) -> None:
        ...
        mod = importlib.import_module("novapaw.token_usage.model_wrapper")
        ...
        *,
        ...
        try:
            ...
            turn_usage = importlib.import_module(
                "novapaw.token_usage.turn_usage",
            )
            token_usage = importlib.import_module("novapaw.token_usage")
