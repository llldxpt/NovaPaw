...
1. deterministic rules (case-insensitive substring match) executing
   ...
   ``notify`` via :func:`novapaw.app.inbox_store.append_event`;
...
# Same parameter style as the novapawmail-mcp mail client.
_ID_COMMAND_ARGS = (
    '("name" "novapawmail-mcp" "version" "0.1.0" "vendor" "novapaw")'
)
