...
from novapaw.constant import DEFAULT_LOCAL_PROVIDER_DIR
...
class LlamaCppBackend:
    """
    NovaPaw local model backend for managing llama.cpp server installation
    and setup.
    """
    ...
    def start_download(
        ...
        spec = ProcessDownloadTaskSpec(
            process_name=f"novapaw-llamacpp-download-{staging_dir.name}",
            command=["novapaw-llamacpp-download", download_url],
