...
This module keeps NovaPaw configuration details behind the PawApp SDK.  A
...
from novapaw.agents.skill_system import get_workspace_skills_dir
from novapaw.agents.utils import (
    copy_workspace_md_files,
    normalize_agent_language,
)
from novapaw.config.config import (
    AgentProfileConfig,
    AgentProfileRef,
    ChannelConfig,
    HeartbeatConfig,
...
from novapaw.config.utils import load_config, save_config
...
class ManagedAgentProfile:
    """Runtime handle for an app-owned NovaPaw agent profile."""
