...
1. ``evacuating_old``: move existing children into ``.novapaw_restore_old``.
...
OLD_CONTENT_DIR_NAME = ".novapaw_restore_old"
STATE_FILE_NAME = ".novapaw_restore_state"
STATE_TMP_FILE_NAME = ".novapaw_restore_state.tmp"
