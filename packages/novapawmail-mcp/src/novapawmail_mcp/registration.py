...
def build_registration_guide(
    ...
    if provider_type == "netease":
        steps = [
            ...
            f"8. Set NOVAPAWMAIL_EMAIL={email} and "
            "NOVAPAWMAIL_AUTH_CODE=<your_authorization_code>.",
        ...
        if domain == "foxmail.com":
            steps = [
                ...
                f"7. Set NOVAPAWMAIL_EMAIL={email} and "
                "NOVAPAWMAIL_AUTH_CODE=<your_authorization_code>.",
    ...
    return {
        ...
        "next_action": (
            ...
            "alternatives. 2. After registration, set NOVAPAWMAIL_EMAIL and "
            "NOVAPAWMAIL_AUTH_CODE, then call check_auth to verify "
            "connectivity."
        ),
    }
