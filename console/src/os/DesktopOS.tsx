...
const BOOT_FLAG_KEY = "novapaw.os.booted";
...
export default function DesktopOS() {
  ...
  return (
    ...
    >
      ...
      {/* Persistent background watermark — NovaPaw OS brand mark. Sits at the
      ...
      <div className={styles.emptyHint}>
        <img src="/novapaw.png" alt="" />
        <div className={styles.emptyBrandName}>NovaPaw OS</div>
      </div>
