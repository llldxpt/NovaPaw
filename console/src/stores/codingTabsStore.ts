...
export const AGENT_FILES_TABS_STORAGE_KEY = "novapaw-agent-files-tabs";
export const SESSION_FILES_TABS_STORAGE_KEY = "novapaw-session-files-tabs";
...
export const useCodingTabsStore = create<CodingTabsState>()(
  persist<CodingTabsState>(
    ...
    {
      name: "novapaw-split-files-workbench",
