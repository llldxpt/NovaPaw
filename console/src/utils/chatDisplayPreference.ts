const TOOL_DISPLAY_MODE_STORAGE_KEY = "novapaw_tool_display_mode";
const LEGACY_TOOL_EXPANDED_STORAGE_KEY = "novapaw_tool_calls_default_expanded";
const ASSISTANT_DISPLAY_MODE_STORAGE_KEY =
  "novapaw_assistant_message_display_mode";
const SHOW_THINKING_STORAGE_KEY = "novapaw_show_thinking";
const CHAT_DISPLAY_PREFERENCE_CHANGE_EVENT =
  "novapaw:chat-display-preference-change";
