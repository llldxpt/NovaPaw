...
const timeoutSpec = {
  key: "NOVAPAW_LLM_STREAM_IDLE_TIMEOUT",
  default: "30",
  effective_value: "30",
  source: "default" as const,
  description_key:
    "environments.variableDescriptions.NOVAPAW_LLM_STREAM_IDLE_TIMEOUT",
  editable: true,
...
describe("EnvironmentsPage", () => {
  it("shows known defaults and custom child-process variables", async () => {
    mockApi.listEnvs.mockResolvedValue([
      { key: "NOVAPAW_LLM_STREAM_IDLE_TIMEOUT", value: "30" },
      { key: "TAVILY_API_KEY", value: "secret" },
    ]);
    renderWithProviders(<EnvironmentsPage />);

    expect(
      await screen.findByText("NOVAPAW_LLM_STREAM_IDLE_TIMEOUT"),
    ).toBeTruthy();
  ...
  it("renders startup values as locked", async () => {
    ...
    await screen.findByText("NOVAPAW_WORKING_DIR");
