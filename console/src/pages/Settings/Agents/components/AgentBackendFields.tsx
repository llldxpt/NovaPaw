...
export function AgentBackendFields({ form, open }: AgentBackendFieldsProps) {
  ...
  const backend =
    (Form.useWatch("backend", form) as AgentBackend | undefined) ?? "novapaw";
  ...
  const selectBackend = useCallback(
    (next: AgentBackend) => {
      const switchingProvider =
        next !== "novapaw" && next !== form.getFieldValue("backend");
      form.setFieldsValue({
        backend: next,
        ...(next === "novapaw" || switchingProvider
          ? { backend_settings: {} }
          : {}),
      });
    },
      ...
      <div className={styles.typeGrid}>
        <button
          ...
          className={`${styles.typeCard} ${
            backend === "novapaw" ? styles.selected : ""
          }`}
          onClick={() => selectBackend("novapaw")}
        >
        ...
        <button
          ...
          onClick={() =>
            selectBackend(backend === "novapaw" ? "codex" : backend)
          }
        >
          <span className={styles.typeIcon}>
            <Blocks size={20} />
                ...
                <div className={styles.capabilityGrid}>
                  <div className={styles.capabilityItem}>
                    ...
                    <span>
                      ...
                      <small>
                        {provider.capabilities.novapaw_skills_projection
                  ...
                  <div className={styles.capabilityItem}>
                    ...
                    <span>
                      ...
                      <small>
                        {provider.capabilities.novapaw_mcp_projection
                          ? t("agent.backend.runtimeInherited")
                          : t("agent.backend.notSupported")}
                      </small>
                    </span>
