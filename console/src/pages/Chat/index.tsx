...
export default function ChatPage() {
  ...
  const captureSubmissionSnapshot = useCallback(
    ...
    [queueSessionId, selectedAgent, usesNovaPawBackend],
  );
  ...
  const enqueueSubmittedInput = useCallback(
    (
      ...
      const queueText = snapshot.usesNovaPawBackend
  ...
  const shouldEnqueueSubmission = useCallback(
    async (snapshot: SubmissionSnapshot): Promise<boolean> => {
      ...
      if (!snapshot.usesNovaPawBackend) return false;
  ...
  const customFetch = useCallback(
    async (data: {
      ...
      pendingDirectSubmissionRef.current = null;
      const requestUsesNovaPawBackend =
        directSubmission?.usesNovaPawBackend ?? usesNovaPawBackend;
  ...
  const options = useMemo(() => {
    ...
    const handleBeforeSubmit = async (
      ...
      const prepared = snapshot.usesNovaPawBackend
      ...
      sender: {
        ...
        actionAffix: (
          ...
          >
            ...
            {usesNovaPawBackend && !isAgentSwitchTransition && (
