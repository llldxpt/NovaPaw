...
describe("SettingsCenter", () => {
  beforeEach(() => {
    ...
    localStorage.removeItem("novapaw_chat_wide_mode");
    ...
    localStorage.removeItem("novapaw-theme");
  ...
  it("uses the dark settings surface when dark theme is active", () => {
    localStorage.setItem("novapaw-theme", "dark");
  ...
  it("persists the standard and wide message widths", async () => {
    ...
    expect(localStorage.getItem("novapaw_chat_wide_mode")).toBe("true");

    await userEvent.click(standard);

    expect(localStorage.getItem("novapaw_chat_wide_mode")).toBeNull();
  });
  ...
  it("persists message display preferences", async () => {
    ...
    expect(localStorage.getItem("novapaw_tool_display_mode")).toBe(
      "raw-input-output",
    );
    expect(localStorage.getItem("novapaw_show_thinking")).toBe("false");
    const storedMode = localStorage.getItem(
      "novapaw_assistant_message_display_mode",
    );
