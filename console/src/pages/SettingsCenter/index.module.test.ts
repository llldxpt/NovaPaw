...
describe("SettingsCenter responsive layout", () => {
  ...
  it("keeps general and sidebar controls legible in dark mode", () => {
    ...
    expect(darkRule).toContain(":global(.novapaw-segmented-item)");
    expect(darkRule).toContain(":global(.novapaw-segmented-item-selected)");
    expect(darkRule).toContain("background: var(--app-fill) !important;");
    expect(darkRule).toContain(":global(.novapaw-btn-default)");
    expect(darkRule).toContain(":global(.novapaw-btn-text)");
    ...
    expect(darkRule).toContain(":global(.novapaw-checkbox-wrapper-disabled)");
