 ...
 * 2. Plugins access and modify module exports via window.NovaPaw.modules
...
class ModuleRegistryImpl implements ModuleRegistry {
  ...
  /**
   * Get all modules (for window.NovaPaw.modules)
   */
...
// Expose to window.NovaPaw.modules (for plugin use)
// Set during initialization
if (typeof window !== "undefined") {
  if (!window.NovaPaw) {
    (window as any).NovaPaw = {};
  }

  // Use Proxy for dynamic access, ensuring plugins always get latest module state
  Object.defineProperty(window.NovaPaw, "modules", {
    get() {
