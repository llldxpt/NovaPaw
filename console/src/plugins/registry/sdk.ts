 ...
 * `window.NovaPaw.{menu, route, slot, audit}`. All plugin-facing methods take
...
export interface NovaPawMenuNamespace {
...
export interface NovaPawRouteNamespace {
...
export interface NovaPawSlotNamespace {
  fill(
    pluginId: string,
    name: SlotName,
    render: SlotRenderer,
...
export function buildMenuNamespace(): NovaPawMenuNamespace {
  return {
    add: (pluginId, item) => {
...
export function buildRouteNamespace(): NovaPawRouteNamespace {
  return {
    add: (pluginId, route) => {
...
export function buildSlotNamespace(): NovaPawSlotNamespace {
  return {
...
export function buildAuditNamespace(): NovaPawAuditNamespace {
  return {
